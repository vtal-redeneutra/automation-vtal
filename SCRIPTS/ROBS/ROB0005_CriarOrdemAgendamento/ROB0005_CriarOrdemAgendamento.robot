...
Criar Ordem Agendamento
    ...
    IF   "${orderType}" == "Instalacao"
        IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
            ...
            IF    ${qntdComp} == 1
                ${Response}=                POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "empresarial","fantasyName": "BOX1001","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": "${HasSlot}","date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}","complement": {"complements": [{"type": "${type1}","value": "${value1}"}]}}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${Action}"}]}}
            END
        ...
        ELSE
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "empresarial","fantasyName": "BOX1001","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": "${HasSlot}","date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}"}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${Action}"}]}}   
        END
    ELSE IF   "${orderType}" == "RemanejamentoPonto"       
            ...
            IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
                ...
                IF    ${qntdComp} == 1
                    ${Response}=            POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]},"workContact":{"name": "sindico Vtal","email":"sindicovtal@vtal.com","phone":"21999900000"}},"appointment": {"hasSlot": "${HasSlot}","date": "${APPOINTMENTDATE}","mandatoryType": "Obrigatorio","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}","complement": {"complements": [{"type": "${type1}","value": "${value1}"}]}}}}
                END
            ...
            ELSE
                ${Response}=                POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]},"workContact":{"name": "sindico Vtal","email":"sindicovtal@vtal.com","phone":"21999900000"}},"appointment": {"hasSlot": "${HasSlot}","date": "${APPOINTMENTDATE}","mandatoryType": "Obrigatorio","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}"}}}
            END
    END
...
Criar Ordem Agendamento FTTP 
    ...
    IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
        ...
        ELSE
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": ${HasSlot},"date": "","mandatoryType": "Permitido","workOrderId": ""},"addresses": {"address": {"id": ${ADDRESSID},"inventoryId": "${INVENTORYID}","reference": "${Reference}"}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${Action}"}]}}
...
Criar Ordem Agendamento Bitstream 
    ...
    IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
        ...
        IF    ${qntdComp} == 1
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "${business_unity}","fantasyName": "Internet Bits","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]},"workContact": {"name": "sindico Vtal","email": "sindicovtal@vtal.com","phone": "21999900000"}},"appointment": {"hasSlot": ${HasSlot},"date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": ${ADDRESSID},"inventoryId": ${INVENTORYID},"reference": "${Reference}","complement": {"complements": [{"type": "${type1}","value": "${value1}"}]}}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${Action}"}]}}
        END
        ...
        ELSE
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "${business_unity}","fantasyName": "Internet Bits","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]},"workContact": {"name": "sindico Vtal","email": "sindicovtal@vtal.com","phone": "21999900000"}},"appointment": {"hasSlot": ${HasSlot},"date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": ${ADDRESSID},"inventoryId": ${INVENTORYID},"reference": "${Reference}"}},"products": {"product": [{"catalogId": "${CatalogID}","action": "adicionar"}]}}
...
Criar ordem sem agendamento                                                                                                                                                                                                                               
    ...
    IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
        ...
        IF    ${qntdComp} == 1
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": "${HasSlot}","date": "","mandatoryType": "Obrigatorio","workOrderId": ""},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}","complement": {"complements": [{"type": "${type1}","value": "${value1}"}]}}},"products":{"product":[{"catalogId":"${CatalogID}","action": "${Action}"}]}}
        END
        ...
        ELSE
            ${Response}=                    POST_API                                ${API_BASEPRODUCTORDERING}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": "${HasSlot}","date": "","mandatoryType": "Obrigatorio","workOrderId": ""},"addresses": {"address": {"id": "${ADDRESSID}","inventoryId": "${INVENTORYID}","reference": "${Reference}"}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${Action}"}]}}
...
Criar Ordem de Agendamento Voip V2
    [Documentation]                         Consome API productOrder V2 e cria ordem de agendamento.
    ...                                     | =Arguments= | =Description= |
    ...                                     | `VELOCIDADE_DOWN` | Se não for passado argumento, a velocidade de download, por padrão, ficará 400 |
    ...                                     | `VELOCIDADE_UP` | Se não for passado argumento, a velocidade de upload, por padrão, ficará 200 |
    ...                                     Cria ordem de agendamento usando o Associated_Document. Se o pedido foi realizado sem agendamento, é gerado um novo Associated_Document para criação da ordem.
    ...
    ELSE IF    "${orderType}" == "Retirada"
        ${ASSOCIATEDDOCUMENTDATE}=              Get Current Date                        increment=30 minutes                    result_format=%Y-%m-%dT%H:%M:00
        ${ASSOCIATEDDOCUMENT}=                  Get Current Date                        result_format=%m%d%H%M%S
        ${ASSOCIATEDDOCUMENT}=                  Set Variable                            ibm${Associated_Document}   
    ...
    #Criar novo correlationOrder
    ${SUBSCRIBERID}=                        Ler Variavel na Planilha                subscriberId                            Global
    ${date_formated}=                       Get Current Date                        result_format=%m%d%H%M%S
    ${CORRELATIONORDER}=                    Set Variable                            COibm${date_formated}        
    Escrever Variavel na Planilha           ${CORRELATIONORDER}                     correlationOrder                        Global
    ...
    #Product
    ${product_NAME}                         Set Variable                            BL_${VELOCIDADE_DOWN}MB
    ...
    #Gerar 10 números aleatorios para o campo "value" da criação da OS Voip
    ${numeros_voip}=                        Generate Random String                  10                                      1234567890
    Escrever Variavel na Planilha           ${numeros_voip}                         numeroVoip                              Global
    ${numeros_voip}                         Ler Variavel na Planilha                numeroVoip                              Global
    ...
    IF    "${type1}" != "None" or "${type2}" != "None" or "${type3}" != "None" 
        ...
        IF    ${qntdComp} == 1
            ${Response}=                    POST_API                                ${API_BASECPOI_V2}/productOrder    "order":{"correlationOrder":"${CORRELATIONORDER}","associatedDocument":"${ASSOCIATEDDOCUMENT}","associatedDocumentDate":"${ASSOCIATEDDOCUMENTDATE}","type":"${Type}","infraType":"${InfraType}","customer":{"name":"${NAME}","subscriberId":"${SUBSCRIBERID}","businessUnity":"${businessUnity}","fantasyName":"${fantasyName}","phoneNumber":{"phoneNumbers":["${PHONENUMBER}","",""]},"workContact":{"name":"sindico Vtal","email":"sindicovtal@vtal.com","phone":"21999900000"}},"appointment":{"hasSlot":"${HasSlot}","date":"${APPOINTMENTDATE}","mandatoryType":"${MandatoryType}","workOrderId":"${WORKORDERID}"},"addresses":{"address":{"id":"${ADDRESSID}","inventoryId":"${INVENTORYID}","reference":"${REFERENCE}","complement":{"complements":[{"type":"${type1}","value":"${value1}"}]}}},"products":{"product":[{"catalogId":"${product_NAME}","action":"${action}"},{"catalogId":"${catalogId}","action":"${action}","attributes":{"attribute":[{"name":"voipNumber","value":"${numeros_voip}"}]}}]}}


        END

        IF    ${qntdComp} == 2
            ${Response}=                    POST_API                                ${API_BASECPOI_V2}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "${businessUnity}","fantasyName": "${fantasyName}","phoneNumber": {"phoneNumbers": ["${phoneNumber}","",""]}},"appointment": {"hasSlot": ${hasSlot},"date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": ${ADDRESSID},"inventoryId": "${INVENTORYID}","reference": "${REFERENCE}","complement": {"complements": [{"type": "${type1}","value": "${value1}","${type2}","value": "${value2}"}]}}},"products": {"product": [{"catalogId": "${CatalogID}","action": "${action}"},{"catalogId": "VoIP","action": "${action}","attributes": {"attribute": [{"name": "voipNumber","value": "${numeros_voip}"}]}}]}}
        END
        ...
        ELSE
            ${Response}=                    POST_API                                ${API_BASECPOI_V2}/productOrder    "order": {"correlationOrder": "${CORRELATIONORDER}","associatedDocument": "${ASSOCIATEDDOCUMENT}","associatedDocumentDate": "${ASSOCIATEDDOCUMENTDATE}","type": "${Type}","infraType": "${InfraType}","customer": {"name": "${NAME}","subscriberId": "${SUBSCRIBERID}","businessUnity": "${businessUnity}","fantasyName": "${fantasyName}","phoneNumber": {"phoneNumbers": ["${PHONENUMBER}","",""]}},"appointment": {"hasSlot": ${HasSlot},"date": "${APPOINTMENTDATE}","mandatoryType": "${MandatoryType}","workOrderId": "${WORKORDERID}"},"addresses": {"address": {"id": ${ADDRESSID},"inventoryId": "${INVENTORYID}","reference": "${REFERENCE}"}},"products": {"product": [{"catalogId": "${product_NAME}","action": "${action}"},{"catalogId": "VoIP","action": "${action}","attributes": {"attribute": [{"name": "voipNumber","value": "${numeros_voip}"}]}}]}}
    ...
    Valida Retorno da API                   ${Response_Code[0]}                     201                                     Created
#===================================================================================================================================================================
