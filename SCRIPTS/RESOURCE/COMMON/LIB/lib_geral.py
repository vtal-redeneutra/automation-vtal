...
# #Doc Manipulation
# document_evidencia = Document('C:/IBM_VTAL/DATA\INPUT/MODELO DEFECT E EVIDENCIA/Evidencia VTAL DOC.docx')
# document_defect = Document('C:/IBM_VTAL/DATA\INPUT/MODELO DEFECT E EVIDENCIA/Defeito VTAL DOC.docx')
# index = 0
# index_OPM = 0
