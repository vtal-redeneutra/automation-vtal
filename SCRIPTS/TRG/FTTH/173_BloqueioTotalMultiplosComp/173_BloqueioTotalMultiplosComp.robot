...
*** Variables ***
${DAT_CENARIO}                              ${DIR_DAT}/173_BloqueioTotalMultiplosComp.xlsx


*** Test Cases ***
173.01 - Gerar Token de Acesso 
    Retornar Token Vtal

173.02 - Realizar o Bloqueio total
    Realiza Bloqueio/Desbloqueio Voip       Type=Bloqueio                           acao=bloquear total                                    

173.03 - Validar o Recebimento da Notificação de Bloqueio no Microserviços
...
173.04 - Realizar Validação no SOM
...
173.05 - Notificação de encerramento da ordem no Microserviços (notificação do SOM)
    Login ao Portal de Microserviços
