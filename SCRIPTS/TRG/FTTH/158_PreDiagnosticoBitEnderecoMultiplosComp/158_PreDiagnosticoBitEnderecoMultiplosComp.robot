...
*** Variables ***
${DAT_CENARIO}                              ${DIR_DAT}/158_PreDiagnosticoBitEnderecoMultiplosComp.xlsx


*** Test Cases ***
158.01 - Gerar Token de Acesso 
    Retornar Token Vtal

158.02 - Realizar configuração na ferramenta de mock 
    Alterar Campo no NETQ                   CAMPO=VULTOATIVO                        VALOR=INVENTORY_18                      RESET_JSON=SIM
    
158.03 - Realizar Pré Diagnóstico
    Realizando PreDiagnostico

158.04 - Realizar Validação do Pré diagnóstico no FW Console
